    ...
    <form className="form-container" onSubmit={handleSubmit}>
      <div className="star">
        ...
        >
          <path
            fill="#d48247"
            d="M12 1l2.5 7.4h7.9l-6.4 4.9 2.5 7.4-6.5-4.9-6.4 4.9 2.5-7.4-6.4-4.9h7.9z"
          />
        </svg>
      </div>
      <div className="form-wrapper">
        ...
        <div className="question-container">
          ...
          >
            ...
            <option value="Happy by Pharrell Williams">
              Happy by Pharrell Williams
            </option>
            <option value="Don't Worry, Be Happy by Bobby McFerrin">
              Don't Worry, Be Happy by Bobby McFerrin
            </option>
            <option value="Walking on Sunshine by Katrina and the Waves">
